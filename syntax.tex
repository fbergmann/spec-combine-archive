...
\token{format} represents a Media type \citep{rfc2046} (previously known as "Internet Media type" or "MIME type"), in which case the \token{format} indicates this Media type.
